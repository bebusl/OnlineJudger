...
const WEB_URL = "https://uni-online-judger.vercel.app/";
export const OAUTH2_REGISTER_REDIRECT_URI = WEB_URL + "oauth2/redirect";
export const OAUTH2_LINK_REDIRECT_URI = WEB_URL + "oauth2/redirect/link";
